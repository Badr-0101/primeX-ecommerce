        ...
        <div className="wrapper">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <button
              ...
              className="flex items-center gap-2 text-primary cursor-pointer hover:bg-primary-hover hover:text-white transition-colors duration-300 border-2 border-primary rounded-lg px-4 py-2 hover:shadow-lg hover:shadow-primary-hover/50 text-sm sm:text-base"
            >
              عرض الكل <ArrowLeft />
            </button>
          </div>
            ...
            {isLoading ? (
              ...
              categories?.map((item) => (
                <motion.div
                  ...
                  onClick={() => navigate(`/products-by-category/${item.id}`)}
